...
async function initializeDatabase() {
    try {
        ...
        `);
            ...
            try {
                await connection.execute(`ALTER TABLE users ADD COLUMN IF NOT EXISTS temp_password_hash VARCHAR(255) NULL`);
            } catch (err) {
                try { await connection.execute(`ALTER TABLE users ADD COLUMN temp_password_hash VARCHAR(255) NULL`); } catch(_) {}
            }
...
async function populateCarsTable(connection) {
    try {
        ...
        const cars = [
            ...
            { name: 'Alfa Romeo Giulietta', description: 'Évjárat: 2012 Hengerűrtartalom: 1368cm³ Teljesítmény: 170 LE Csomagtartó: 350 liter', price_per_day: 4000, image_url: 'https://upload.wikimedia.org/wikipedia/commons/7/76/2011_Alfa_Romeo_Giulietta_Veloce_JTDm-2_2.0_Front.jpg', category: 'Gazdaságos', transmission: 'manual', fuel_type: 'benzin', seats: 5 },
            ...
            { name: 'Volvo V40', description: 'Évjárat: 2014 Hengerűrtartalom: 1969cm³ Teljesítmény: 150 LE Csomagtartó: 335 liter', price_per_day: 10000, image_url: 'https://www.lloydmotorgroup.com/VehicleLibrary/53063-1-rTIPrJaz5U6AkjenmnClw.jpg?height=648.75&heightratio=0.75&mode=crop&upscale=true&width=865', category: 'kompakt', transmission: 'automatic', fuel_type: 'diesel', seats: 5 },
            ...
            { name: 'Volkswagen Golf 6', description: 'Évjárat: 2012 Hengerűrtartalom: 1598cm³ Teljesítmény: 105 LE Csomagtartó: 350 liter', price_per_day: 4000, image_url: 'https://upload.wikimedia.org/wikipedia/commons/a/a2/VW_Golf_1.6_TDI_Style_%28VI%29_%E2%80%93_Frontansicht%2C_25._Februar_2012%2C_Ratingen.jpg', category: 'kompakt', transmission: 'manual', fuel_type: 'diesel', seats: 5 },
            { name: 'Hyundai i30', description: 'Évjárat: 2014 Hengerűrtartalom: 1396cm³ Teljesítmény: 99 LE Csomagtartó: 600 liter', price_per_day: 4500, image_url: 'https://kocsi-media.hu/948/hyundai-i30-cw-1-4-crdi-comfort-749539_547236_1xl.jpg', category: 'kompakt', transmission: 'automatic', fuel_type: 'benzin', seats: 5 },
            ...
            { name: 'Skoda Octavia', description: 'Évjárat: 2016 Hengerűrtartalom: 1968cm³ Teljesítmény: 150 LE Csomagtartó: 610 liter', price_per_day: 10000, image_url: 'https://img.autobazar.eu/foto/MjUyeDE5Ni9maWx0ZXJzOnF1YWxpdHkoODApOmZvcm1hdCh3ZWJwKS9hYm0=/igNBdnllv0_fss?st=p_4slzoNSIXwvZgr5eObRgudKmCkE1f_8ptdr0PcM78&ts=1770987900&e=0', category: 'Középkategória', transmission: 'manual', fuel_type: 'diesel', seats: 5 },
            { name: 'Mazda 6', description: 'Évjárat: 2015 Hengerűrtartalom: 2191cm³ Teljesítmény: 175 LE Csomagtartó: 480 liter', price_per_day: 11000, image_url: 'https://cms-assets.autoscout24.com/uaddx06iwzdz/19TLIpjwPxGgTRUfiGyFtm/d8887ab3bf2e09ad97da06bfb1c93f37/mazda-6-l-01.jpg?w=1100', category: 'Középkategória', transmission: 'automatic', fuel_type: 'diesel', seats: 5 },
            { name: 'Lexus IS', description: 'Évjárat: 2006 Hengerűrtartalom: 2231cm³ Teljesítmény: 177 LE Csomagtartó: 378 liter', price_per_day: 7000, image_url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1l0ju2DHFH4RPTWsNyBIDRYBu7EFsed-0Sg&s', category: 'Középkategória', transmission: 'automatic', fuel_type: 'petrol', seats: 5 },
            ...
            { name: 'Ford Mustang', description: 'Évjárat: 2025 Hengerűrtartalom: 5000cm³ Teljesítmény: 460 LE Csomagtartó: 381 liter', price_per_day: 75000, image_url: 'https://exportimg.hasznaltautocdn.com/2048x1536/6053/21755053/10519920/watermark=0/51e5366e021734a6e5cf0e42022b084a4b6187ded03c51fda55ff5711e0152cc.jpg', category: 'sports', transmission: 'automatic', fuel_type: 'benzin', seats: 4 },
        ];
